...
function StatusBadge({ status }: { status: ArticleStatus }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium border ${variants[status]}`}
    >
...
export default function AdminDashboard() {
  ...
  const draftCount = allArticles.filter(
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your Inside Pet Tech content
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <StatsCard
          ...
          label="Featured"
          value={featuredCount}
          color="bg-crimson-100 text-crimson-600"
        />
      </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <div className="border-b border-border px-4">
            <TabsList className="bg-transparent border-0 h-12">
              <TabsTrigger
                value="all"
                className="data-[state=active]:border-b-2 data-[state=active]:border-crimson-600 rounded-none"
              >
